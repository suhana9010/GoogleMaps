                        ...
                        if(response.isSuccessful()){
                            for(int i=0;i<response.body().getResults().length;i++){
                                ...
                                if(placeType.equals("hospital"))
                                    markerOptions.icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_baseline_local_hospital_24));
                                    ...
                                    markerOptions.icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_baseline_school_24));
